...
function load_config(){
	...
	define('ENCRYPTKEY', '13'); // Encryption key for messages
	define('DBHOST', 'localhost'); // Database host
	define('DBUSER', 'chimpyx2_admin'); // Database user
	define('DBPASS', 'meme21'); // Database password
	define('DBNAME', 'chimpyx2_chat'); // Database
